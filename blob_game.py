...
def main():
    ...
    blue_blobs = dict(enumerate([Blob(BLUE) for i in range(STARTING_BLUE_BLOBS)])) #giving the blobs an id each
    red_blobs = dict(enumerate([Blob(RED) for i in range(STARTING_RED_BLOBS)])) #giving the blobs an id each
